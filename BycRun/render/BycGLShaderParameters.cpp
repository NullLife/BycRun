...
#include "../common/BycStringUtils.h"

#include "../scene/BycParamsDataSource.h"
...
void BycGLShaderParameters::addUniformParameter(BycGLShaderParamField::FieldContent conent,
                                                BycGLShaderParamField::FieldDataType dataType,
                                                int index) {
    UniformParam param(conent, dataType, index);
    ...
    if (BycGLShaderParamField::isFloat(dataType)) {
        ...
        _floatData.resize(_floatData.size() + BycGLShaderParamField::getFieldCommponents(dataType));
    } else if (BycGLShaderParamField::isInt(dataType)) {
        param.setCursor(_intData.size());
        _intData.resize(_intData.size() + BycGLShaderParamField::getFieldCommponents(dataType));
    } else if (BycGLShaderParamField::isDouble(dataType)) {
        param.setCursor(_doubleData.size());
        _doubleData.resize(_doubleData.size() + BycGLShaderParamField::getFieldCommponents(dataType));
    }
