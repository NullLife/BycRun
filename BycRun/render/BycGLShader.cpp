...
_name(""), _filePath(""), _language("glsl"), _verison("410"), _type(GL_VERTEX_SHADER), _id(0),
...
_name(filePath), _filePath(filePath), _language("glsl"), _verison("410"), _type(shaderType), _id(0),
_params(new BycGLShaderParameters()),
_compiled(false) {
...
void BycGLShader::setLanguageVerison(const String &verison) {
    _verison = verison;
}


const String &BycGLShader::getLanguageVerison() const { 
    return _verison;
}
