...
void BycDeferredLightApp::initScene() {
    ...
    BycCommponent* commp = _sceneManager->getCommponent("deffered");
...
void BycDeferredLightApp::initMaterial(BycEntity* entity, EntityMtlThings things) {
    ...
    fragShader->getParameters()->addUniformParameter(BycGLShaderParamField::FieldContent::SAMPLER_2D,
    ...
    for (int i=0; i<lights.size(); ++i) {
        ...
        switch (type) {
            ...
            case BycLight::LightType::POINT:
                fragShader->getParameters()->addUniformParameter(BycGLShaderParamField::FieldContent::CAMERA_POSITION,
